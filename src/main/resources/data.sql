...
--INSERT INTO blocked_period (start_date, end_date, employee_id)VALUES ('2023-07-01', '2023-07-07', 1);
--INSERT INTO blocked_period (start_date, end_date, employee_id) VALUES ('2023-08-01', '2023-08-07', 4);
...
INSERT INTO vacation_request (start_date, end_date, employee_id, status, vacation_type, notes) VALUES ('2023-07-09', '2023-07-16', 5, 'HANDLED', 'PARENTAL_LEAVE', 'Parental leave for vacation.');
INSERT INTO vacation_request (start_date, end_date, employee_id, status, vacation_type, notes) VALUES ('2023-08-09', '2023-08-16', 4, 'HANDLED', 'VACATION_LEAVE', 'Annual leave for vacation.');
INSERT INTO vacation_request (start_date, end_date, employee_id, status, vacation_type, notes) VALUES ('2023-09-09', '2023-09-16', 6, 'PENDING', 'SICK_LEAVE', 'Recovering from illness.');
INSERT INTO vacation_request (start_date, end_date, employee_id, status, vacation_type, notes) VALUES ('2023-10-14', '2023-10-30', 7, 'HANDLED', 'PUBLIC_HOLIDAY', 'Extended public holiday.');
